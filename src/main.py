...
class VirtualControllerApp:
    ...
    def __init__(self):
        ...
        self.title_font = pygame.font.SysFont("serif", font_size + 6)
    ...
    def _setup_buttons(self) -> None:
        ...
        self.left_lock_x_btn = Button(
            ...
            left_center_y + joystick_radius + self.config.get_scaled_int(20),
        ...
        self.right_lock_x_btn = Button(
            ...
            right_center_y + joystick_radius + self.config.get_scaled_int(20),
            button_width, button_height,
            "Lock X", self.font, self.config
        )
        ...
        self.emergency_btn = Button(
            ...
            "ARM", self.font, self.config, button_id=9
        )
        self.center_all_btn = Button(
            center_x + self.config.get_scaled_int(10), button_y, 
            self.config.get_scaled_int(100), self.config.get_scaled_int(30),
            "RTH", self.font, self.config, button_id=10
        )
    ...
    def _set_ui_scale(self, scale_factor: float) -> None:
        ...
        # Reinitialize fonts with new sizes - using serif for better readability
        font_size = self.config.get("ui.font_size", 14)
        self.font = pygame.font.SysFont("serif", font_size)
        self.title_font = pygame.font.SysFont("serif", font_size + 6)
        ...
        for event in pygame.event.get():
            ...
            # Handle joystick events
                ...
                if event.button == 1:  # Left mouse button
                    ...
                    # Handle button releases for all vJoy buttons (including ARM/RTH)
    ...
    def _draw_status(self) -> None:
        ...
        # VJoy status removed for cleaner UI
