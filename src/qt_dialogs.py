    ...
    def _get_button_info(self) -> list[tuple[int, str, str]]:
        ...
        if self.layout_type == "adaptive":
            ...
            return [
                ...
                (5, "LB", self.config.get("buttons.button_5.label", "LB/SHIFT")),
                (6, "RB", self.config.get("buttons.button_6.label", "RB")),
                (7, "α (View)", self.config.get("buttons.button_7.label", "View/Back")),
                (8, "β (Menu)", self.config.get("buttons.button_8.label", "Menu/Start")),
                (9, "L3", self.config.get("buttons.button_9.label", "LS")),
                (10, "R3", self.config.get("buttons.button_10.label", "RS")),
                (11, "D-Up", self.config.get("buttons.button_11.label", "DPad Up")),
                (12, "D-Down", self.config.get("buttons.button_12.label", "DPad Down")),
                (13, "D-Left", self.config.get("buttons.button_13.label", "DPad Left")),
                (14, "D-Right", self.config.get("buttons.button_14.label", "DPad Right")),
