...
if exist "dist\Project-Nimbus-1.4.1.exe" del /q "dist\Project-Nimbus-1.4.1.exe"
...
if not exist "dist\Project-Nimbus-1.4.1.exe" (
    echo.
...
echo.
echo ================================================
echo SUCCESS! Executable created: dist\Project-Nimbus-1.4.1.exe
echo ================================================
echo.
...
if errorlevel 1 (
    ...
    if errorlevel 1 (
        ...
        echo.
        echo Installer created: dist\Project-Nimbus-Setup-1.4.1.exe
    )
)

echo.
echo You can now:
echo 1. Run dist\Project-Nimbus-1.4.1.exe directly
echo 2. Sign with: build_tools\sign_exe.bat
echo 3. Distribute dist\Project-Nimbus-Setup-1.4.1.exe (if NSIS was available)
echo.
