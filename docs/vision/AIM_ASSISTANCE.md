...
#### Measured thresholds, and the default that cannot serve all three (2026-09-07)

The harness has now put three games' right-stick thresholds on the same scale, and the default floor of **0.289** (anti-deadzone 26.5 plus buffer) sits in a different place relative to each:
